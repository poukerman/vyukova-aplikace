...
const SLOVA_1 = [
  ...
  { veta: 'Pes b_l věrný kamarád.',       odpoved: 'y' },
];
...
const SLOVA_2 = [
  ...
  { veta: 'Vypráv_l příběh do noci.',        odpoved: 'ě' },
  { veta: 'Žák odp_sal správnou odpověď.',   odpoved: 'i' },
  { veta: 'Výsledek ho překvap_l.',          odpoved: 'i' },
  { veta: 'Ros_l jsem na vesnici.',          odpoved: 'i' },
];
